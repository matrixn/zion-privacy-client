...
final class ConsentBanner
{
    ...
    public function enqueue(): void
    {
        ...
        wp_localize_script('zion-privacy-banner', 'ZionPrivacyBanner', [
            ...
            'rejectAllLabel' => $settings['banner_reject_all_label'],
            'customizeLabel' => $settings['banner_customize_label'],
            'saveLabel' => $settings['banner_save_label'],
            'showAccept' => (bool) $settings['banner_show_accept'],
            'showReject' => (bool) $settings['banner_show_reject'],
            'showRejectAll' => (bool) $settings['banner_show_reject_all'],
            'showCustomize' => (bool) $settings['banner_show_customize'],
            'showSavePreferences' => (bool) $settings['banner_show_save_preferences'],
